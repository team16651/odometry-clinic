...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 15.810677103661538; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.75; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.01085432915214; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.019559686156872; // Multiplier in the Y direction
